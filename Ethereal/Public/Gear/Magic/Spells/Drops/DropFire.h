...
#include "DropFire.generated.h"

UCLASS()
class ETHEREAL_API ADropFire : public AActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ADropFire(const FObjectInitializer& ObjectInitializer);
	...
	void Start_Fire(AEtherealPlayerMaster* Caster);
};
