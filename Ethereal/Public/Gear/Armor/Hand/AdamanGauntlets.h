...
#include "AdamanGauntlets.generated.h"

UCLASS()
class ETHEREAL_API AAdamanGauntlets : public AArmor_Master
{
	GENERATED_BODY()
	
public:

	AAdamanGauntlets(const FObjectInitializer& ObjectInitializer);
