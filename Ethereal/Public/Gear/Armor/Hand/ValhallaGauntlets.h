...
#include "ValhallaGauntlets.generated.h"

UCLASS()
class ETHEREAL_API AValhallaGauntlets : public AArmor_Master
{
	GENERATED_BODY()
	
public:

	AValhallaGauntlets(const FObjectInitializer& ObjectInitializer);
