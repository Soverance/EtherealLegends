...
#include "CrimsonBreastplate.generated.h"

UCLASS()
class ETHEREAL_API ACrimsonBreastplate : public AArmor_Master
{
	GENERATED_BODY()
	
public:

	ACrimsonBreastplate(const FObjectInitializer& ObjectInitializer);
