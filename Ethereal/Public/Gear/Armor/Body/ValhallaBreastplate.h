...
#include "ValhallaBreastplate.generated.h"

UCLASS()
class ETHEREAL_API AValhallaBreastplate : public AArmor_Master
{
	GENERATED_BODY()
	
public:

	AValhallaBreastplate(const FObjectInitializer& ObjectInitializer);
