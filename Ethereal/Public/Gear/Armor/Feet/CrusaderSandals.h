...
#include "CrusaderSandals.generated.h"

UCLASS()
class ETHEREAL_API ACrusaderSandals : public AArmor_Master
{
	GENERATED_BODY()
	
public:

	ACrusaderSandals(const FObjectInitializer& ObjectInitializer);
