...
#include "ValhallaGreaves.generated.h"

UCLASS()
class ETHEREAL_API AValhallaGreaves : public AArmor_Master
{
	GENERATED_BODY()
	
public:

	AValhallaGreaves(const FObjectInitializer& ObjectInitializer);
