...
#include "ValhallaFlanchard.generated.h"

UCLASS()
class ETHEREAL_API AValhallaFlanchard : public AArmor_Master
{
	GENERATED_BODY()
	
public:

	AValhallaFlanchard(const FObjectInitializer& ObjectInitializer);
