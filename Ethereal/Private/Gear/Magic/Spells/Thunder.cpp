	...
	: Super(ObjectInitializer)
{
	...
	NameText = LOCTEXT("ThunderName", "Thunder");
	Type = EMasterGearTypes::GT_Black;
	TypeText = LOCTEXT("ThunderType", "Black Magic");
	Description = "Send a bolt of lightning from the heavens to decimate all targets within range.";
	Price = 10000;
	MPCost = 75;
	ATK = 5;
	DEF = 0;
