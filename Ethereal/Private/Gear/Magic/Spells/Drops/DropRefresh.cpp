...
#include "DropRefresh.h"


// Sets default values
ADropRefresh::ADropRefresh(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> CastParticleObject(TEXT("ParticleSystem'/Game/Blueprints/Gear/Magic/SpellEffects/P_Refresh.P_Refresh'"));
...
void ADropRefresh::BeginPlay()
{
	...
	GetWorldTimerManager().SetTimer(BlastTimer, this, &ADropRefresh::DestroyDrop, 60.0f, false);
}

// Called every frame
void ADropRefresh::Tick( float DeltaTime )
{
