...
#include "Ethereal.h"
#include "DemonArrow.h"

#define LOCTEXT_NAMESPACE "EtherealText"

// Sets default values
ADemonArrow::ADemonArrow(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	...
	Name = EMasterGearList::GL_DemonArrow;
	NameText = LOCTEXT("DemonArrowName", "Demon Arrow");
	Type = EMasterGearTypes::GT_Ammo;
	TypeText = LOCTEXT("DemonArrowType", "Ammunition");
	Description = "Arrows tipped with demon scales, forged by Shadowsmiths.";
	Price = 40000;
	MPCost = 0.0f;
	ATK = 20.0f;
	DEF = 10.0f;
