	...
	: Super(ObjectInitializer)
{
	...
	GetMesh()->SetRelativeLocation(FVector(105, 0, 0));
	...
	TargetingReticle->SetRelativeLocation(FVector(0, 140, 105));
	TargetingReticle->SetRelativeRotation(FRotator(0, 0, -90));
...
void AProtoZhan::InitAggro()
{
	...
	GetWorldTimerManager().SetTimer(AggroTimer, this, &AProtoZhan::FallToAggro, 9.8f, false);
}

void AProtoZhan::FallToAggro()
{
	...
	GetWorldTimerManager().SetTimer(AttackTimer, this, &AProtoZhan::StartAttacking, 7.0f, false);
}

void AProtoZhan::StartAttacking()
{
	Targetable = true;
...
void AProtoZhan::Escape()
{
	...
	FTimerHandle EndTimer;
	GetWorldTimerManager().SetTimer(EndTimer, this, &AProtoZhan::Explode, 4.0f, false);
}

void AProtoZhan::Explode()
{
	...
	FTimerHandle EndTimer;
	GetWorldTimerManager().SetTimer(EndTimer, this, &AProtoZhan::DropPortal, 0.5f, false);
}

void AProtoZhan::DropPortal()
{
...
// Jump Timeline
void AProtoZhan::TimelineFloatReturn(float val)
{
